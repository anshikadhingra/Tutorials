...
data_set = read.csv('C:/Users/mayan/SkillEdge/Analytics/R programs/R codes/Analytics_Edge_R/data/HR_Data_Tutorial 7.csv')
View(data_set)
...
#Usinghod to change the in-built data type of variables:
...
# ----------------------- role --------------------------------
# To check Plan S transform metubscription ratio in dataset
